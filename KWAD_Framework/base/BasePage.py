...
class BasePage:
    ...
    def waitForElement(self, locatorValue, locatorType):
        ...
        element = None
        wait = WebDriverWait(self.driver, 25, poll_frequency=25,
    ...
    def getElement(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Element Not found with LocatorType" + locatorType +
    ...
    def clickElement(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Unable to click Element with LocatorType" + locatorType +
                          "with the locatorValue" + locatorValue)
    ...
    def sendText(self,text,locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Send text on Element found with LocatorType" + locatorType +
                          "and with the locatorValue" + locatorValue)
        except:
            self.log.info("Unable to send text with LocatorType" + locatorType +
                          "with the locatorValue" + locatorValue)
    ...
    def isDisplayed(self,locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("Element with LocatorType" + locatorType +
                          "with the locatorValue" + locatorValue + "is not displayed")
            return False
    ...
    def screenShot(self,screenshotName):
        ...
        try:
            ...
            self.log.info("Screenshot save to the path" + screenshotPath)
        except:
